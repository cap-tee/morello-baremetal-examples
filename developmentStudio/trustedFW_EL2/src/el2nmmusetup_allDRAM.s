/*
 ============================================================================
 Name        : el2nmmusetup_allDRAM.s
 Author      : CAP-TEE
 Version     :
 Copyright   : CAP-TEE 2021
 Description : Basic translation table for EL2N to use all DRAM memory and peripherals
...
el2nmmu:
  ...
  // include in the MMU translation
...
//------------------------------------------//--
  ...
  //setting these cause it to fall over when running the Morello - android boot up
  // sequence to stop at EL2
 ...
 // ORR      x0, x0, #(1 << 12)                // bit[12] I=1    Enable instruction fetches for caches
  ...
  //*****************************************
  // ------------------------------------------------------------
  // Translation table for EL2N
  // This is where the EL2N table is stored in memory
  // ------------------------------------------------------------
