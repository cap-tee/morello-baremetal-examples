/*
 ...
 Description : The vector table here is for EL1N
 			   ...
 			   Each exception level (EL3, EL2, EL1) should have its own vector table.
               ...
               Only one label is defined here irqFirstLevelHandler, which branches off to the fiqHandler function
               defined in exceptionHandlerFuncsEL1N
 ============================================================================
 */
 /*This section needs to go into non secure memory region */
  .section  .NONSECUREvectortableel1N_ass,"ax"
  .align 12
...
// exception handler function, which is defined in the exceptionHandlerFuncsEL1N.c
  .global irqHandlerEL1N
...
spx_currentEL_SYNC:
  ...
  .balign 128
spx_currentEL_IRQ:
  B        irqFirstLevelHandler //        IRQ handler for timer
...
irqFirstLevelHandler:
  ...
  // go to the exceptionHandlerFuncsEL1N functions
  BL       irqHandlerEL1N
